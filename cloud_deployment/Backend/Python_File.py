...
#    print(round((weight0 * 0.25 + weight1 * 0.12 + weight2 * 0.12 + weight3 * 0.15 + weight4 * 0.18 + weight5 * 0.18), 2))
    ...
    if verdict > 4.3:
        ...
        if index >= 100:
            index = 100
        if index >= 92:
            output['verdict'] = ["WE ARE "+ str(index) +"% SURE THAT THIS SONG WOULD BE A BLOCKBUSTER HIT" ]
        elif index >= 80 and index < 92:
            output['verdict'] = ["WE ARE "+ str(index) +"% SURE THAT THIS SONG WOULD BE A  SUPER HIT" ]
        elif index >= 60 and index<80:
            output['verdict'] = ["WE ARE "+ str(index) +"% SURE THAT THIS SONG WOULD BE A POPULAR HIT" ]
        else:
            output['verdict'] = ["WE ARE "+ str(index) +"% SURE THAT THIS SONG WOULD BE A HIT, BUT WITH SOME MORE EFFORT, IT COULD TURN OUT TO BE A BLOCKBUSTER HIT" ]
    else:
